...
namespace Illuminate\Support\Facades {
    ...
    class DB {
        ...
        /**
         * Indicates whether native alter operations will be used when dropping or renaming columns, even if Doctrine
         * DBAL is installed.
         *
         * @return bool
         * @static
    ...
    class Schema {
        ...
        /**
         * Attempt to use native schema operations for dropping and renaming columns, even if Doctrine DBAL is
         * installed.
         *
         * @param bool $value
         *
