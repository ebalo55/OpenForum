...
>
    ...
    >
        <div class="space-y-2">
                                        ...
                                        <md-unordered-list class="w-full h-full">
                                            <svg @class([
                                                ...
                                                'dark:fill-current' => config('forms.dark_mode'),
                                                 ...
                                                 data-icon="list-ul" role="img" xmlns="http://www.w3.org/2000/svg"
                                                 viewBox="0 0 512 512">
                                                <path fill="currentColor"
                                        ...
                                        <md-ordered-list class="w-full h-full">
                                            <svg @class([
                                                ...
                                                'dark:fill-current' => config('forms.dark_mode'),
                                                 ...
                                                 data-icon="list-ol" role="img" xmlns="http://www.w3.org/2000/svg"
                                                 viewBox="0 0 576 512">
                                                <path fill="currentColor"
            ...
            ]) x-show="tab === 'preview'" {{-- x-html="preview" --}} x-cloak style="min-height: 150px;">
                    {{-- Use the customized markdown render by spatie in order to support all the PHPLeague extensions installed --}}
                    <x-markdown>{{\Illuminate\Support\Arr::dot($this)[$getStatePath()]}}</x-markdown>
                </div>
        </div>
    </div>
</x-dynamic-component>
