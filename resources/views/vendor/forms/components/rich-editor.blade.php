                ...
                <div
                    ...
                    <div class="flex items-stretch space-x-4 outline-none rtl:space-x-reverse">
                                    ...
                                    >
                                        <svg @class([
                                            ...
                                            'dark:fill-current' => config('forms.dark_mode'),
                                             ...
                                             role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                                            <path fill="currentColor"
                                                  d="M384 64.01c0 17.69-14.31 32-32 32h-58.67l-133.3 320H224c17.69 0 32 14.31 32 32s-14.31 32-32 32H32c-17.69 0-32-14.31-32-32s14.31-32 32-32h58.67l133.3-320H160c-17.69 0-32-14.31-32-32s14.31-32 32-32h192C369.7 32.01 384 46.33 384 64.01z"></path>
                                        </svg>
                                    </x-forms::rich-editor.toolbar-button>
                                @endif
                                    ...
                                    >
                                        <svg @class([
                                            ...
                                            'dark:fill-current' => config('forms.dark_mode'),
                                             ...
                                             data-icon="strikethrough" role="img" xmlns="http://www.w3.org/2000/svg"
                                             viewBox="0 0 512 512">
                                            <path fill="currentColor"
                        ...
                        @if ($hasToolbarButton(['h1', 'h2', 'h3']))
                            <div data-trix-button-group="heading-tools"
                                 class="flex items-stretch space-x-1 rtl:space-x-reverse">
                        ...
                        @if ($hasToolbarButton(['blockquote', 'codeBlock', 'bulletList', 'orderedList']))
                            <div data-trix-button-group="block-tools"
                                 class="flex items-stretch space-x-1 rtl:space-x-reverse">
                                @if ($hasToolbarButton('blockquote'))
                                    ...
                                    >
                                        <svg @class([
                                            'h-4',
                                            'dark:fill-current' => config('forms.dark_mode'),
                                        ]) aria-hidden="true" focusable="false" data-prefix="fas" data-icon="quote-left"
                                ...
                                @if ($hasToolbarButton('codeBlock'))
                                    ...
                                    >
                                        <svg @class([
                                            'h-4',
                                            'dark:fill-current' => config('forms.dark_mode'),
                                        ]) aria-hidden="true" focusable="false" data-prefix="fas" data-icon="code"
                                             role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                            <path fill="currentColor"
                                ...
                                @if ($hasToolbarButton('bulletList'))
                                    ...
                                    >
                                        <svg @class([
                                            'h-4',
                                            'dark:fill-current' => config('forms.dark_mode'),
                                        ]) aria-hidden="true" focusable="false" data-prefix="fas" data-icon="list-ul"
                            ...
                            @if ($hasToolbarButton('undo'))
                                ...
                                >
                                    <svg @class([
                                        'h-4',
                                        'dark:fill-current' => config('forms.dark_mode'),
                                    ]) aria-hidden="true" focusable="false" data-prefix="fas" data-icon="rotate-left"
                                         role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                        <path fill="currentColor"
                            ...
                            @if ($hasToolbarButton('redo'))
                                ...
                                >
                                    <svg @class([
                                        'h-4',
                                        'dark:fill-current' => config('forms.dark_mode'),
                                    ]) aria-hidden="true" focusable="false" data-prefix="fas" data-icon="rotate-right"
                                         role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                        <path fill="currentColor"
                    ...
                    >
                        <div class="trix-dialog__link-fields">
                            <input
                                ...
                                aria-label="{{ __('forms::components.rich_editor.dialogs.link.label') }}" required
                                data-trix-input
                                disabled
                                type="url"
