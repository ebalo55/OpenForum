<div style="text-align: center">
    <svg id="f20e0c25-d928-42cc-98d1-13cc230663ea" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
         xmlns:xlink="http://www.w3.org/1999/xlink" width="300" viewBox="0 0 820.16 780.81">
        <defs>
        ...
        <path
            ...
            transform="translate(-189.92 -59.59)" fill="#4285f4"/>
        ...
        <rect x="377.02" y="104.56" width="199.84" height="47.27" fill="#4285f4"/>
        <path
    ...
    @if (! is_dir(public_path('vendor/binarytorch')))
        <hr>
        <h4>Please don't forget to fire the install command!</h4>
        <h4><span style="background-color: #e16a6b; color: #fff; padding: 5px; border-radius: 5px;">php artisan larecipe:install</span>
        </h4>
    @endif
</div>
